...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .plan-card.active-free { border-color: #22c55e; box-shadow: 0 0 0 3px rgba(34,197,94,0.15); }
    .plan-card.active-starter { border-color: #3b82f6; box-shadow: 0 0 0 3px rgba(59,130,246,0.15); }
    .plan-card.active-growth { border-color: #a855f7; box-shadow: 0 0 0 3px rgba(168,85,247,0.15); }
    .plan-card.active-pro { border-color: #f59e0b; box-shadow: 0 0 0 3px rgba(245,158,11,0.15); }

    .plan-head { padding: 16px 14px; text-align: center; }
    .plan-head.free-h { background: linear-gradient(135deg, #f0fdf4, #dcfce7); }
    .plan-head.starter-h { background: linear-gradient(135deg, #eff6ff, #dbeafe); }
    .plan-head.growth-h { background: linear-gradient(135deg, #faf5ff, #ede9fe); }
    .plan-head.pro-h { background: linear-gradient(135deg, #fffbeb, #fef3c7); }
    ...
    .plan-icon.free-i { background: linear-gradient(135deg, #22c55e, #16a34a); }
    .plan-icon.starter-i { background: linear-gradient(135deg, #3b82f6, #0ea5e9); }
    .plan-icon.growth-i { background: linear-gradient(135deg, #a855f7, #ec4899); }
    .plan-icon.pro-i { background: linear-gradient(135deg, #f59e0b, #ef4444); }

    .plan-name { font-size: 13px; font-weight: 800; color: var(--slate-700); }
    ...
    .plan-btn.free-btn { background: linear-gradient(135deg, #4b5563, #374151); }
    .plan-btn.starter-btn { background: linear-gradient(135deg, #3b82f6, #0ea5e9); }
    .plan-btn.growth-btn { background: linear-gradient(135deg, #a855f7, #ec4899); }
    .plan-btn.pro-btn { background: linear-gradient(135deg, #f59e0b, #ef4444); }
...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a class="nav-item" href="#">
        <div class="nav-icon"><i class="fa fa-chalkboard-teacher"></i></div> Teachers
      </a>
      <a class="nav-item" href="#">
        <div class="nav-icon"><i class="fa fa-book-open"></i></div> Subject
      </a>
      <a class="nav-item" href="#">
        <div class="nav-icon"><i class="fa fa-user-graduate"></i></div> Students
      </a>
      <a class="nav-item" href="#">
        <div class="nav-icon"><i class="fa fa-layer-group"></i></div> Classes
      </a>
  ...
  <div class="main">
    ...
    <nav class="navbar">
      <div class="navbar-left">
        <div class="navbar-search">
          <i class="fa fa-search" style="color:#94a3b8;font-size:11px;"></i>
        ...
        <div class="section-body">
          <div class="grid-4" style="margin-bottom:14px;">
            ...
            <div class="stat-box">
              ...
              <div class="value green">Active <i class="fa fa-check-circle" style="font-size:13px;"></i></div>
            </div>
            <div class="stat-box">
              <div class="label">Start Date</div>
              <div class="value" style="font-size:14px;">2025-01-01</div>
            </div>
            <div class="stat-box">
              <div class="label">Expiry Date</div>
              <div class="value" style="font-size:14px;">N/A</div>
            </div>
          </div>
          <div class="alert amber">
            <i class="fa fa-exclamation-triangle"></i>
            <p><strong>You are on the FREE Plan —</strong> Limited to 3 students and 1 teacher. Upgrade to unlock more features.</p>
          </div>
        </div>
      </div>
      ...
      <div class="section-card">
        ...
        <div class="section-body">
          <div class="plans-grid">
            ...
            <!-- FREE -->
            <div class="plan-card active-free">
              <div class="plan-head free-h">
                <div class="plan-icon free-i"><i class="fa fa-gift"></i></div>
              ...
              <div class="plan-body">
                <ul class="plan-features">
                  <li><i class="fa fa-check-circle"></i> Up to 3 students</li>
                  <li><i class="fa fa-check-circle"></i> 1 teacher only</li>
                  <li><i class="fa fa-check-circle"></i> Basic dashboard access</li>
                  <li><i class="fa fa-check-circle"></i> Results & timetable view</li>
                  <li><i class="fa fa-check-circle"></i> Limited system features</li>
                </ul>
                <div class="plan-badge amber">⚠ Best for testing</div>
            ...
            <!-- STARTER -->
            <div class="plan-card">
              <div class="plan-head starter-h">
                <div class="plan-icon starter-i"><i class="fa fa-star"></i></div>
              ...
              <div class="plan-body">
                <ul class="plan-features">
                  <li><i class="fa fa-check-circle"></i> Up to 100 students</li>
                  <li><i class="fa fa-check-circle"></i> Multiple teachers</li>
                  <li><i class="fa fa-check-circle"></i> Full dashboards</li>
                  <li><i class="fa fa-check-circle"></i> Result management</li>
                  <li><i class="fa fa-check-circle"></i> Timetable & exams</li>
                </ul>
                <div class="plan-badge green">✅ Small private schools</div>
                <button class="plan-btn starter-btn" onclick="selectPlan('starter')">Upgrade to Starter</button>
              </div>
            </div>

            <!-- GROWTH -->
            <div class="plan-card">
              <div class="plan-head growth-h">
                <div class="plan-icon growth-i"><i class="fa fa-chart-line"></i></div>
              ...
              <div class="plan-body">
                <ul class="plan-features">
                  <li><i class="fa fa-check-circle"></i> Up to 300 students</li>
                  <li><i class="fa fa-check-circle"></i> Unlimited teachers</li>
                  <li><i class="fa fa-check-circle"></i> Advanced result processing</li>
                  <li><i class="fa fa-check-circle"></i> Class & subject management</li>
                  <li><i class="fa fa-check-circle"></i> Priority performance</li>
                </ul>
                <div class="plan-badge blue">🚀 Growing institutions</div>
                <button class="plan-btn growth-btn" onclick="selectPlan('growth')">Upgrade to Growth</button>
              </div>
            </div>
            ...
            <div class="plan-card">
              ...
              <div class="plan-head pro-h">
                <div class="plan-icon pro-i"><i class="fa fa-crown"></i></div>
              ...
              <div class="plan-body">
                <ul class="plan-features">
                  <li><i class="fa fa-check-circle"></i> Unlimited students</li>
                  <li><i class="fa fa-check-circle"></i> Unlimited teachers</li>
                  <li><i class="fa fa-check-circle"></i> Full system access</li>
                  <li><i class="fa fa-check-circle"></i> High performance & scalability</li>
                  <li><i class="fa fa-check-circle"></i> Priority support</li>
                </ul>
                <div class="plan-badge amber">🏆 Large or multi-campus schools</div>
                <button class="plan-btn pro-btn" onclick="selectPlan('pro')">Upgrade to Pro</button>
              </div>
            </div>
          ...
          <div class="grid-2" style="margin-bottom:16px;">
            ...
            <div class="info-box">
              ...
              <div class="info-row">
                ...
                <span class="val">GTBank (Guaranty Trust Bank)</span>
              </div>
              <div class="info-row">
                <span class="key">Account Name</span>
                <span class="val">Hammock Tech Global</span>
              </div>
              <div class="info-row">
                <span class="key">Account Number</span>
                <span class="val">0639278826</span>
              </div>
            </div>
    ...
    <!-- FOOTER -->
    <div class="footer">
      <span>© 2025 CoreDesk — Powered by Hammock Tech Global</span>
