...
<div class="w-full px-6 py-6 mx-auto">
    ...
    <form method="POST" action="{{ route('tenant.students.update', [$subdomain, $student->id]) }}">
        ...
        <div class="flex items-center justify-between">
            ...
            <button type="submit"
                    class="px-8 py-2.5 text-sm font-semibold text-black rounded-lg bg-gradient-to-tl from-gray-900 to-slate-700 shadow-soft-md hover:shadow-soft-xl hover:scale-105 transition-all">
