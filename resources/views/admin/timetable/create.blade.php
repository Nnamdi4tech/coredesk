...
<div class="w-full px-6 py-6 mx-auto">
    ...
    <div class="flex flex-wrap items-center justify-between mb-6 -mx-3">
        <div class="px-3">
            <h3 class="text-2xl font-bold text-slate-700 mb-1">Add Timetable Entry</h3>
    ...
    <div class="bg-white shadow-soft-xl rounded-2xl overflow-hidden">
        ...
        <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100">
            ...
            <div>
                <h6 class="font-bold text-slate-700 mb-0">New Timetable Entry</h6>
                <p class="text-xs text-slate-400 mt-0.5">Schedule a subject for a specific class</p>
            </div>
        </div>

        <form method="POST" action="{{ route('tenant.timetable.store', $subdomain) }}" class="p-6">
            @csrf
...
<div>
    ...
    @error('teacher_id') <p class="text-xs text-red-500 mt-1">{{ $message }}</p> @enderror
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-600 mb-1.5">
                        <i class="fa fa-calendar-day mr-1 text-slate-400"></i> Day <span class="text-red-500">*</span>
                    </label>
                    ...
                    @error('day') <p class="text-xs text-red-500 mt-1">{{ $message }}</p> @enderror
                </div>
            ...
            <div class="flex items-center justify-end gap-3 mt-6 pt-4 border-t border-gray-100">
                ...
                <button type="submit"
                    ...
                    <i class="fa fa-save mr-1"></i> Save Timetable Entry
                </button>
            </div>
        </form>
    </div>
