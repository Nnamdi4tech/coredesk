    ...
    <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
           href="/admin/teachers">
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Teachers</span>
        </a>
    </li>
            ...
            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5">
                <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                    ...
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g fill-rule="nonzero">
                            <path class="fill-slate-800 opacity-60"
                                  d="M23,0 L46,10 L23,20 L0,10 Z"/>
                            <path class="fill-slate-800"
                                  d="M8,14.5 L8,28 C8,34.627 14.9,40 23,40 C31.1,40 38,34.627 38,28 L38,14.5 L23,20.5 Z M46,10 L46,26"/>
                        </g>
                    </g>
                </svg>
            </div>
            ...
            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                    ...
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g fill-rule="nonzero">
                            <path class="fill-slate-800 opacity-60"
                                  d="M2,0 L40,0 C41.1045695,-2.02906125e-16 42,0.8954305 42,2 L42,30 C42,31.1045695 41.1045695,32 40,32 L2,32 C0.8954305,32 1.3527075e-16,31.1045695 0,30 L0,2 C-1.3527075e-16,0.8954305 0.8954305,2.02906125e-16 2,0 Z"/>
                            <path class="fill-slate-800"
                                  d="M14,32 L14,42 M28,32 L28,42 M8,42 L34,42"/>
                        </g>
                    </g>
                </svg>
            </div>
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Classes</span>
        </a>
    </li>
    ...
    <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
           href="/admin/finance">
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Finance</span>
        </a>
    </li>
                    ...
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g fill-rule="nonzero">
                            <path class="fill-slate-800 opacity-60"
                                  d="M2,0 L40,0 C41.1045695,-2.02906125e-16 42,0.8954305 42,2 L42,30 C42,31.1045695 41.1045695,32 40,32 L2,32 C0.8954305,32 1.3527075e-16,31.1045695 0,30 L0,2 C-1.3527075e-16,0.8954305 0.8954305,2.02906125e-16 2,0 Z"/>
                            <path class="fill-slate-800"
                                  d="M14,32 L14,42 M28,32 L28,42 M8,42 L34,42 M10,14 L32,14 M10,20 L24,20"/>
                        </g>
                    </g>
                </svg>
            </div>
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">My Classes</span>
        </a>
    </li>
            ...
            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5">
                <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                    ...
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g fill-rule="nonzero">
                            <path class="fill-slate-800 opacity-60"
                                  d="M34,4 L38,4 C39.1045695,4 40,4.8954305 40,6 L40,42 C40,43.1045695 39.1045695,44 38,44 L2,44 C0.8954305,44 0,43.1045695 0,42 L0,6 C0,4.8954305 0.8954305,4 2,4 L6,4 M12,0 L28,0 C29.1045695,0 30,0.8954305 30,2 L30,6 C30,7.1045695 29.1045695,8 28,8 L12,8 C10.8954305,8 10,7.1045695 10,6 L10,2 C10,0.8954305 10.8954305,0 12,0 Z"/>
                            <path class="fill-slate-800"
                                  d="M11,24 L17,30 L29,18"/>
                        </g>
                    </g>
                </svg>
            </div>
    ...
    <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
           href="/teacher/results">
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Results</span>
        </a>
    </li>
                    ...
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g fill-rule="nonzero">
                            <path class="fill-slate-800 opacity-60"
                                  d="M34,4 L38,4 C39.1045695,4 40,4.8954305 40,6 L40,42 C40,43.1045695 39.1045695,44 38,44 L2,44 C0.8954305,44 0,43.1045695 0,42 L0,6 C0,4.8954305 0.8954305,4 2,4 L6,4 M12,0 L28,0 C29.1045695,0 30,0.8954305 30,2 L30,6 C30,7.1045695 29.1045695,8 28,8 L12,8 C10.8954305,8 10,7.1045695 10,6 L10,2 C10,0.8954305 10.8954305,0 12,0 Z"/>
                            <path class="fill-slate-800"
                                  d="M10,18 L30,18 M10,24 L30,24 M10,30 L20,30"/>
                        </g>
                    </g>
                </svg>
            </div>
