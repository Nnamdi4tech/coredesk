<!-- cards row 4 -->
                      ...
                      <tr>
                        <td
                          ...
                          <div class="flex px-2 py-1">
                            <div>
                              <img
                                src="{{ asset('dashboard/build/assets/img/small-logos/logo-xd.svg') }}"   
                        ...
                        <td
                          ...
                          <div class="mt-2 avatar-group">
                            <a
                              ...
                              <img
                                src="{{ asset('dashboard/build/assets/img/team-1.jpg') }}"   
                            ...
                            <a
                              ...
                              data-placement="bottom">
                              <img
                                src="{{ asset('dashboard/build/assets/img/team-2.jpg') }}"  
                                class="w-full rounded-full"
                                alt="team2" />
                            </a>
                            <div
                            ...
                            <a
                              ...
                              data-placement="bottom">
                              <img
                                src="{{ asset('dashboard/build/assets/img/team-3.jpg') }}"
                                class="w-full rounded-full"
                                alt="team3" />    
                            </a>
                            <div
                            ...
                            <a
                              ...
                              data-placement="bottom">
                              <img
                                src="{{ asset('dashboard/build/assets/img/team-4.jpg') }}"
                                class="w-full rounded-full"
                                alt="team4" />
                            </a>
                            <div
                      ...
                      <tr>
                        <td
                          ...
                          <div class="flex px-2 py-1">
                            <div>
                              <img
                                src="{{ asset('dashboard/build/assets/img/small-logos/logo-atlassian.svg') }}" 
                                class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                alt="atlassian" />
                            </div>
                            <div class="flex flex-col justify-center">
                      ...
                      <tr>
                        <td
                          ...
                          <div class="flex px-2 py-1">
                            <div>
                              <img
                                src="{{ asset('dashboard/build/assets/img/small-logos/logo-slack.svg') }}"  
                                class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                alt="team7" />
                            </div>
                            <div class="flex flex-col justify-center">
                      ...
                      <tr>
                        <td
                          ...
                          <div class="flex px-2 py-1">
                            <div>
                              <img
                                src="{{ asset('dashboard/build/assets/img/small-logos/logo-spotify.svg') }}" 
                                class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                alt="spotify" />
                            </div>
                            <div class="flex flex-col justify-center">
                      ...
                      <tr>
                        <td
                          ...
                          <div class="flex px-2 py-1">
                            <div>
                              <img
                                src="{{ asset('dashboard/build/assets/img/small-logos/logo-jira.svg') }}"  
                                class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                alt="jira" />
                            </div>
                            <div class="flex flex-col justify-center">
                      ...
                      <tr>
                        <td
                          ...
                          <div class="flex px-2 py-1">
                            <div>
                              <img
                                src="{{ asset('dashboard/build/assets/img/small-logos/logo-invision.svg') }}" 
                                class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                alt="invision" />
                            </div>
                            <div class="flex flex-col justify-center">
       ...
       </div>  <!--  Note remove this last div, if the style didnt come out well  -->
