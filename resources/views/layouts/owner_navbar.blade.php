...
<nav
  ...
  <div
    ...
    <nav>
      ...
      @php
    $user = auth()->user();
    $name = $user ? explode(' ', $user->name)[0] : 'Owner';
        ...
        <li class="relative flex items-center pr-2">
          ...
          <a
            ...
            <div class="flex items-center">
              ...
              <span class="ml-2 hidden sm:inline-block font-semibold">  {{ $name }}</span>
...
<li class="relative flex items-center pr-2">
    {{-- ... entire user dropdown ... --}}
</li>
@else -->
<li class="flex items-center">
    <a href="{{ route('owner.login') }}"
       class="block px-0 py-2 text-sm font-semibold transition-all ease-nav-brand text-slate-500">
        <i class="fa fa-sign-in-alt sm:mr-1"></i>
...
<!-- ends here -->
          ...
          <form id="logout-form" action="{{ route('owner.logout') }}" method="POST" class="hidden">
