...
<div class="w-full px-6 py-6 mx-auto">
                    ...
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                ...
                                <h5 class="mb-0 font-bold text-slate-700 text-2xl">
                                    {{ $tenants->count() }}
                                </h5>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                ...
                                <h5 class="mb-0 font-bold text-green-600 text-2xl">
                                    {{ $tenants->where('is_active', true)->count() }}
                                </h5>
                            </div>
                        </div>
                        <div class="px-3 text-right basis-1/3">
                    ...
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                ...
                                <h5 class="mb-0 font-bold text-red-600 text-2xl">
                                    {{ $tenants->where('is_active', false)->count() }}
                                </h5>
                            </div>
                        </div>
                        <div class="px-3 text-right basis-1/3">
    ...
    {{-- All Tenants Table with Actions --}}
                    ...
                    <tr class="border-t border-gray-100 hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 align-middle">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-xl bg-gradient-to-tl from-blue-500 to-cyan-400 flex items-center justify-center text-white text-xs font-bold shadow-soft-md">
                        ...
                        <td class="px-6 py-4 align-middle">
    <form method="POST" 
          action="/owner/tenant/{{ $tenant->id }}/plan" 
          class="inline-block"
          onsubmit="return confirm('Are you sure you want to update the plan and set 30 days for {{ $tenant->name }}?')">
        @csrf
        <div class="flex items-center gap-2">
            ...
            <button type="submit"
                ...
                <i class="fa fa-save mr-1"></i> Update
                        ...
                        <td class="px-6 py-4 align-middle text-center text-sm">{{ $tenant->expires_at ?? 'N/A' }}</td>
                        <td class="px-6 py-4 align-middle text-center">
                            <div class="flex items-center justify-center gap-2">
                                <form method="POST" action="/owner/tenant/{{ $tenant->id }}/toggle" class="inline">
                                    @csrf
                                    <button type="submit" 
                        ...
                        <td class="px-6 py-4 align-middle text-center">
                                <form method="POST" action="/owner/tenant/{{ $tenant->id }}/extend" class="inline">
                                    @csrf
                                    <button type="submit" 
...
<div class="bg-white shadow-soft-xl rounded-2xl overflow-hidden">
    <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100">
        <div class="w-8 h-8 rounded-lg bg-gradient-to-tl from-purple-500 to-pink-400 flex items-center justify-center shadow-soft-md">
            <i class="fa fa-user-shield text-white text-xs"></i>
        </div>
        <div>
    ...
    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 hover:bg-gray-50 transition-colors">
        <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-xl bg-gradient-to-tl from-purple-500 to-pink-400 flex items-center justify-center text-white text-sm font-bold shadow-soft-md">
            ...
            <div>
                ...
                <p class="text-xs text-blue-500 mt-0.5">
                     <strong>{{ $tenant->subdomain }}.coredesk.local.coredesk.local</strong>
                </p>
            </div>
        </div>
